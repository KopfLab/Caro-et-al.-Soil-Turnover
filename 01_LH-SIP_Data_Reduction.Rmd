...
### Join raw and memory-corrected (mc) datasets

```{r}
# peaks_mapped_with_zeros_FID_mc <- peaks_mapped_with_zeros_FID %>% 
#   # Need to remove "BF" from Analysis number
#   mutate(Analysis = parse_number(Analysis)) %>%
#   # Join
#   left_join(
...
#     by = c("Analysis", "sample_id", "compound"))
# 
# peaks_mapped_with_threes_FID_mc <- peaks_mapped_with_threes_FID %>% 
#   # Need to remove "BF" from Analysis number
#   mutate(Analysis = parse_number(Analysis)) %>%
#   # Join
#   left_join(
