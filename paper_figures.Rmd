...
### Error propagation data (assimilation efficiency)

```{r}
gen_calc_errorprop <- read_csv("data_output/gen_calc_errorprop.csv")
```
...
# cowplot::save_plot(filename = "fig_output/p_lit_turnover_w_ours.pdf",
