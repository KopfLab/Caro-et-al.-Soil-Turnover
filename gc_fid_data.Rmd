...
results_trip %>% ggplot(aes(x = `Retention Time`, y = `Relative Area`, color = sample_rep, fill = sample_rep)) +
  geom_col() +
  geom_errorbar(aes(ymin=rel_area_min, ymax = rel_area_max), color = "black") +
  theme_classic()

######### PICK UP WITH THIS GGPLOT!
```
